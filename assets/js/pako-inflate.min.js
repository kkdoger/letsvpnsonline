      ...
      8: [
        function (e, t, i) {
          ...
          function s(e) {
            var t;
            return e && e.state
              ? (((t = e.state).wsize = 0), (t.whave = 0), (t.wnext = 0), o(e))
              : U;
          }
          function f(e, t) {
            var i, n;
          ...
          function H(e) {
            if (u) {
              ...
              for (
                C(I, e.lens, 0, 288, d, 0, e.work, { bits: 9 }), t = 0;
                t < 32;

              )
                e.lens[t++] = 5;
              C(D, e.lens, 0, 32, c, 0, e.work, { bits: 5 }), (u = !1);
            }
            (e.lencode = d),
              (e.lenbits = 9),
              (e.distcode = c),
          ...
          function j(e, t, i, n) {
            ...
            return (
              ...
              n >= r.wsize
                ? (z.arraySet(r.window, t, i - r.wsize, r.wsize, 0),
                  (r.wnext = 0),
                  (r.whave = r.wsize))
                : (n < (a = r.wsize - r.wnext) && (a = n),
                  z.arraySet(r.window, t, i - n, a, r.wnext),
                  (n -= a)
                    ? (z.arraySet(r.window, t, i - n, n, 0),
                      (r.wnext = n),
                      (r.whave = r.wsize))
                    : ((r.wnext += a),
                ...
                switch (i.mode) {
                  ...
                  case 19:
                    for (; i.have < i.nlen + i.ndist; ) {
                      for (
                        ;
                        (k =
                          ((Z = i.lencode[l & ((1 << i.lenbits) - 1)]) >>> 16) &
                          255),
                          (_ = 65535 & Z),
                          !((w = Z >>> 24) <= d);
                  ...
                  case 23:
                    for (
                      ;
                      (k =
                        ((Z = i.distcode[l & ((1 << i.distbits) - 1)]) >>> 16) &
                        255),
                        (_ = 65535 & Z),
                        !((w = Z >>> 24) <= d);
                ...
                j(e, e.output, e.next_out, u - e.avail_out)
                  ...
                  : ((c -= e.avail_in),
                    ...
                    i.wrap &&
                      ...
                      (e.adler = i.check =
                        i.flags
                          ? N(i.check, a, u, e.next_out - u)
                          : R(i.check, a, u, e.next_out - u)),
                    (e.data_type =
                      i.bits +
                      (i.last ? 64 : 0) +
                      (12 === i.mode ? 128 : 0) +
            ...
            for (;;) {
              for (
                b = _ - S,
                  ...
                  f = 1 << (_ - S),
                  v = l = 1 << y;
                (a[u + (B >> S) + (l -= f)] = (b << 24) | (m << 16) | w | 0),
                  0 !== l;

              );
              for (f = 1 << (_ - 1); B & f; ) f >>= 1;
              if (
                (0 !== f ? ((B &= f - 1), (B += f)) : (B = 0), g++, 0 == --R[_])
              ) {
                if (_ === p) break;
                _ = t[i + o[g]];
              }
              if (x < _ && (B & c) !== d) {
                for (
                  0 === S && (S = x), u += v, E = 1 << (y = _ - S);
                  y + S < p && !((E -= R[y + S]) <= 0);

                )
                  y++, (E <<= 1);
                if (
                  ((Z += 1 << y), (1 === e && 852 < Z) || (2 === e && 592 < Z))
                )
                  return 1;
        ...
        function (e, t, i) {
            ...
            if (
              ...
              t.dictionary &&
                ('string' == typeof t.dictionary
                  ...
                  : '[object ArrayBuffer]' === m.call(t.dictionary) &&
          ...
          (o.prototype.push = function (e, t) {
            ...
            do {
              if (
                (0 === s.avail_out &&
                  ((s.output = new u.Buf8(f)),
                  (s.next_out = 0),
                  (s.avail_out = f)),
                (i = c.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT &&
                  l &&
                  (i = c.inflateSetDictionary(this.strm, l)),
                i === b.Z_BUF_ERROR && !0 === d && ((i = b.Z_OK), (d = !1)),
